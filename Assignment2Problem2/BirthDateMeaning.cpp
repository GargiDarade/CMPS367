// C++ implementation of Assignment 2 Problem 2: Birthday Date Meaning Generator , with variables as Structures
...
int main()
{
    ...
    while(objStructOfVars.loop)
    {
        ...
        cin>> objStructOfVars.month;
        cout<<"\nPlease enter the day of your birthday (1 - 31): ";
        cin>> objStructOfVars.day;
        cout<<"\nPlease enter the year of your birthday (2000 - 2023): ";
        cin>> objStructOfVars.year; 
        cout<<"\n\nThe month of "<< objStructOfVars.month <<" means:";
        cout<<"\n"<<MonthMeaning(objStructOfVars.month)<<"\n";
        cout<<"\nThe "<<objStructOfVars.day<<" of "<<objStructOfVars.month<<" means:";
        cout<<"\n"<<BirthdayDateMeaning(objStructOfVars.day)<<"\n";
        cout<<"\nThe year of "<< objStructOfVars.year << " means:";
        cout<<"\n"<<BirthdayYearMeaning(objStructOfVars.year)<<"\n";
